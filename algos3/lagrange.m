...
%
%      LAGRANGE('Property','Value',...) creates a new LAGRANGE using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to lagrange_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      LAGRANGE('CALLBACK') and LAGRANGE('CALLBACK',hObject,...) call the
%      local function named CALLBACK in LAGRANGE.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 13-Nov-2014 14:24:19
