...
%FORWARD M-file for forward.fig
...
%
%      FORWARD('Property','Value',...) creates a new FORWARD using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to forward_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      FORWARD('CALLBACK') and FORWARD('CALLBACK',hObject,...) call the
%      local function named CALLBACK in FORWARD.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 14-Nov-2014 18:46:40
